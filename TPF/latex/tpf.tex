...
Para la solución del problema, se utilizó un AG \cite{Goldberg1989}, \cite{Roeva2012} en el que se utilizó un fenotipo como se muestra en la Fig. \ref{fig2}.
...
Para contrastar, en las Fig. \ref{fig7} y Fig. \ref{fig8} se muestra el resultado para un fitness regular. Los resultados que corresponden a este fitness se muestran en la Tabla \ref{tab6}, donde se sombrearon los solapamientos. Se puede apreciar en la Fig. \ref{fig7} que los parámetros utilizados no son los óptimos según la Tabla \ref{tab5}.
...
Como trabajo futuro, se plantea la inclusión de más restricciones a la función de aptitud, tales como requerimientos propios de los profesores o relacionadas a la disponibilidad y equipamiento de las aulas. En un análisis prelimiar, concluímos que no habría mayor dificultad, siguiendo el enfoque actual, en implementar estas extensiones. 
