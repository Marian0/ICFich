...
Especializamos el trabajo en nuestra propia carrera: Ingeniería en Informática. Por lo tanto, modelamos las asignaturas de los 5 años de la misma. También se resumieron las clases de cada materia a 3: una de teoría y dos de práctica (a las que los alumnos deben acudir a ambas). Un ejemplo para las primeras asignaturas se ve en la Tabla I. Luego se estudiará el caso más general.
